            ...
            <div rel="followerdiv" @if($followerk > 1) style="display:none;" @else current="1" @endif>
                ...
                <li> 
                    ...
                    <div class="fans_span2 txt-hide">
                        <a href="{{ route('pc:mine', ['user_id'=>$fv['id']]) }}"><img src="@if(!empty($fv->info['avatar'])) {{ $fv->info['avatar'] }} @else {{ $routes['resource'] }}/images/avatar.png @endif" class="fans_img" /></a>
                        <a href="{{ route('pc:mine', ['user_id'=>$fv['id']]) }}">{{$fv->name}}</a>
                    </div>
        ...
        <ul class="fans_ul">
            ...
            <div rel="creditdiv" @if($creditk > 1) style="display:none;" @else current="1" @endif>
                ...
                <li>
                    ...
                    <div class="fans_span2 txt-hide">
                        <a href="{{ route('pc:mine', ['user_id'=>$cv['id']]) }}"><img src="{{ $cv->info['avatar'] }}" class="fans_img" /></a>
                        <a href="{{ route('pc:mine', ['user_id'=>$cv['id']]) }}">{{$cv->name}}</a>
                    </div>
        ...
        <ul class="fans_ul">
            ...
            <div rel="postdiv" @if($postk > 1) style="display:none;" @else current="1" @endif>
                ...
                <li>
                    ...
                    <div class="fans_span2 txt-hide">
                        <a href="{{ route('pc:mine', ['user_id'=>$pv['id']]) }}"><img src="{{ $pv->info['avatar'] }}" class="fans_img" /></a>
                        <a href="{{ route('pc:mine', ['user_id'=>$pv['id']]) }}">{{$pv->name}}</a>
                    </div>
        ...
        <ul class="fans_ul">
            ...
            <div rel="checktotaldiv" @if($checktotalk > 1) style="display:none;" @else current="1" @endif>
                ...
                <li>
                    ...
                    <div class="fans_span2 txt-hide">
                        <a href="{{ route('pc:mine', ['user_id'=>$tv['id']]) }}"><img src="{{ $tv->info['avatar'] }}" class="fans_img" /></a>
                        <a href="{{ route('pc:mine', ['user_id'=>$tv['id']]) }}">{{$tv->name}}</a>
                    </div>
