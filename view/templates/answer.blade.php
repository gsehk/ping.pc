...
@foreach ($datas as $data)
	<div class="qa-item">
	    <div class="qa-body mb20 clearfix">
	        ...
	        @endif
	        <span class="tcolor margin0">{!! str_limit(preg_replace('@\@*\!\[\w*\]\(([https]+\:\/\/[\w\/\.]+|[0-9]+)\)@', '[图片]', $data->body), 250, '...') !!}</span><a href="{{ route('pc:answeread', $data->id) }}" class="button button-plain button-more">查看详情</a>
	    </div>
