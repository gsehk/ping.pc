...
<div class="pay-box">
    ...
    <div class="pay-form">
        ...
        <p><input class="custom-sum" type="text" name="custom" placeholder="钱包余额{{ $TS['wallet']['balance'] }}"></p>
        <p><input class="custom-sum" type="text" name="account" placeholder="输入支付宝账号"></p>
        <p class="tcolor">选择提现方式</p>
        <div class="pay-way">
            <label class="opt active" for="alipay">支付宝<input class="hide" id="alipay" type="radio" name="payway" value="alipay" checked></label>
