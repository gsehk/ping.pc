...
<div class="pay-box">
    ...
    <div class="pay-form">
        ...
        <p><input min="1" oninput="value=moneyLimit(value)" class="custom-sum" type="text" name="custom" placeholder="钱包余额{{ $TS['wallet']['balance'] * ($config['bootstrappers']['wallet:ratio']) }}"></p>
...
$('#J-pay-btn').on('click', function(){
    ...
    axios.post('/api/v2/wallet/cashes', params)
      .then(function (response) {
        noticebox('提现成功，请等待管理员审核', 1, '/wallet/3');
      })
